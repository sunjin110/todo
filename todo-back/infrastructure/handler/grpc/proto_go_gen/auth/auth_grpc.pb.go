...
func (c *authClient) SignUp(ctx context.Context, in *SignUpInput, opts ...grpc.CallOption) (*SignUpOutput, error) {
...
func (c *authClient) SignOut(ctx context.Context, in *SignOutInput, opts ...grpc.CallOption) (*SignOutOutput, error) {
...
func (UnimplementedAuthServer) SignUp(context.Context, *SignUpInput) (*SignUpOutput, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SignUp not implemented")
}
func (UnimplementedAuthServer) SignIn(context.Context, *SignInInput) (*SignInOutput, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SignIn not implemented")
}
func (UnimplementedAuthServer) SignOut(context.Context, *SignOutInput) (*SignOutOutput, error) {
...
func _Auth_SignOut_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).SignOut(ctx, req.(*SignOutInput))
	}
	return interceptor(ctx, in, info, handler)
}
