...
func (c *authenticationClient) SignUp(ctx context.Context, in *SignUpInput, opts ...grpc.CallOption) (*SignUpOutput, error) {
...
func (c *authenticationClient) SignIn(ctx context.Context, in *SignInInput, opts ...grpc.CallOption) (*SignInOutput, error) {
...
func (c *authenticationClient) SignOut(ctx context.Context, in *SignOutInput, opts ...grpc.CallOption) (*SignOutOutput, error) {
...
func (UnimplementedAuthenticationServer) SignUp(context.Context, *SignUpInput) (*SignUpOutput, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SignUp not implemented")
}
func (UnimplementedAuthenticationServer) SignIn(context.Context, *SignInInput) (*SignInOutput, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SignIn not implemented")
}
func (UnimplementedAuthenticationServer) SignOut(context.Context, *SignOutInput) (*SignOutOutput, error) {
...
func _Authentication_SignUp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthenticationServer).SignUp(ctx, req.(*SignUpInput))
	}
...
func _Authentication_SignIn_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthenticationServer).SignIn(ctx, req.(*SignInInput))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Authentication_SignOut_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthenticationServer).SignOut(ctx, req.(*SignOutInput))
	}
	return interceptor(ctx, in, info, handler)
}
