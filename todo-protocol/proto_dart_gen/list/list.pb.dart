...
class Paging extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Paging', package: const $pb.PackageName(_omitMessageNames ? '' : 'list'), createEmptyInstance: create)
...
class SortField extends $pb.GeneratedMessage {
  ...
  SortField._() : super();
  factory SortField.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SortField.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SortField', package: const $pb.PackageName(_omitMessageNames ? '' : 'list'), createEmptyInstance: create)
    ..e<SortKind>(1, _omitFieldNames ? '' : 'sortKind', $pb.PbFieldType.OE, defaultOrMaker: SortKind.FilterAsc, valueOf: SortKind.valueOf, enumValues: SortKind.values)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SortField copyWith(void Function(SortField) updates) => super.copyWith((message) => updates(message as SortField)) as SortField;
  ...
  @$core.pragma('dart2js:noInline')
  static SortField getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SortField>(create);
  static SortField? _defaultInstance;

  @$pb.TagNumber(1)
  SortKind get sortKind => $_getN(0);
  @$pb.TagNumber(1)
  set sortKind(SortKind v) { setField(1, v); }
  @$pb.TagNumber(1)
