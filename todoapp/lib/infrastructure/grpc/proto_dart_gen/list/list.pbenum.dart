...
class FilterKind extends $pb.ProtobufEnum {
  static const FilterKind FilterUnknown = FilterKind._(0, _omitEnumNames ? '' : 'FilterUnknown');
  static const FilterKind FilterPartialMatch = FilterKind._(1, _omitEnumNames ? '' : 'FilterPartialMatch');
  static const FilterKind FilterPerfectMatch = FilterKind._(2, _omitEnumNames ? '' : 'FilterPerfectMatch');
...
class SortKind extends $pb.ProtobufEnum {
  static const SortKind FilterAsc = SortKind._(0, _omitEnumNames ? '' : 'FilterAsc');
  static const SortKind FilterDesc = SortKind._(1, _omitEnumNames ? '' : 'FilterDesc');
  ...
  static final $core.Map<$core.int, SortKind> _byValue = $pb.ProtobufEnum.initByValue(values);
