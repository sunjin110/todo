...
class User extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<$0.UserSignUpStatus>(
        4, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE,
        defaultOrMaker: $0.UserSignUpStatus.SignupSignUpStatusUnknown,
        valueOf: $0.UserSignUpStatus.valueOf,
        enumValues: $0.UserSignUpStatus.values)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(4)
  set status($0.UserSignUpStatus v) {
    setField(4, v);
  }
...
class CreateUser extends $pb.GeneratedMessage {
  ...
  CreateUser._() : super();
  factory CreateUser.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CreateUser.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'CreateUser',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'user'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  CreateUser copyWith(void Function(CreateUser) updates) =>
      super.copyWith((message) => updates(message as CreateUser)) as CreateUser;
  ...
  @$core.pragma('dart2js:noInline')
  static CreateUser getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CreateUser>(create);
...
class UpdateUser extends $pb.GeneratedMessage {
  ...
  UpdateUser._() : super();
  factory UpdateUser.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory UpdateUser.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'UpdateUser',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'user'),
      createEmptyInstance: create)
    ..aOM<UserId>(1, _omitFieldNames ? '' : 'id', subBuilder: UserId.create)
    ..aOS(2, _omitFieldNames ? '' : 'name')
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  UpdateUser copyWith(void Function(UpdateUser) updates) =>
      super.copyWith((message) => updates(message as UpdateUser)) as UpdateUser;
  ...
  @$core.pragma('dart2js:noInline')
  static UpdateUser getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<UpdateUser>(create);
...
class CreateInput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<CreateUser>(2, _omitFieldNames ? '' : 'user',
        subBuilder: CreateUser.create)
    ..hasRequiredFields = false;
...
class UpdateInput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$0.Session>(1, _omitFieldNames ? '' : 'session',
        subBuilder: $0.Session.create)
    ..aOM<UpdateUser>(2, _omitFieldNames ? '' : 'user',
        subBuilder: UpdateUser.create)
    ..hasRequiredFields = false;
...
class UserFilter extends $pb.GeneratedMessage {
  ...
  UserFilter._() : super();
  factory UserFilter.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory UserFilter.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'UserFilter',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'user'),
      createEmptyInstance: create)
    ..aOM<UserId>(1, _omitFieldNames ? '' : 'id', subBuilder: UserId.create)
    ..aOS(2, _omitFieldNames ? '' : 'name')
    ..e<$2.FilterKind>(
        3, _omitFieldNames ? '' : 'nameFilterKind', $pb.PbFieldType.OE,
        defaultOrMaker: $2.FilterKind.FilterUnknown,
        valueOf: $2.FilterKind.valueOf,
        enumValues: $2.FilterKind.values)
    ..aOS(4, _omitFieldNames ? '' : 'email')
    ..e<$2.FilterKind>(
        5, _omitFieldNames ? '' : 'emailFilterKind', $pb.PbFieldType.OE,
        defaultOrMaker: $2.FilterKind.FilterUnknown,
        valueOf: $2.FilterKind.valueOf,
        enumValues: $2.FilterKind.values)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  UserFilter copyWith(void Function(UserFilter) updates) =>
      super.copyWith((message) => updates(message as UserFilter)) as UserFilter;
  ...
  @$core.pragma('dart2js:noInline')
  static UserFilter getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<UserFilter>(create);
  ...
  @$pb.TagNumber(3)
  set nameFilterKind($2.FilterKind v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(5)
  set emailFilterKind($2.FilterKind v) {
    setField(5, v);
  }
...
class UserSort extends $pb.GeneratedMessage {
  ...
  UserSort._() : super();
  factory UserSort.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory UserSort.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'UserSort',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'user'),
      createEmptyInstance: create)
    ..aOM<$2.SortField>(1, _omitFieldNames ? '' : 'lastLogin',
        subBuilder: $2.SortField.create)
    ..aOM<$2.SortField>(2, _omitFieldNames ? '' : 'createTime',
        subBuilder: $2.SortField.create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  UserSort copyWith(void Function(UserSort) updates) =>
      super.copyWith((message) => updates(message as UserSort)) as UserSort;
  ...
  @$core.pragma('dart2js:noInline')
  static UserSort getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UserSort>(create);
  static UserSort? _defaultInstance;

  @$pb.TagNumber(1)
  $2.SortField get lastLogin => $_getN(0);
  @$pb.TagNumber(1)
  set lastLogin($2.SortField v) {
    setField(1, v);
  }
...
class ListInput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$0.Session>(1, _omitFieldNames ? '' : 'session',
        subBuilder: $0.Session.create)
    ..aOM<$2.Paging>(2, _omitFieldNames ? '' : 'paging',
        subBuilder: $2.Paging.create)
    ..aOM<UserFilter>(3, _omitFieldNames ? '' : 'filter',
        subBuilder: UserFilter.create)
    ..aOM<UserSort>(4, _omitFieldNames ? '' : 'sort',
        subBuilder: UserSort.create)
    ..hasRequiredFields = false;
...
class ListOutput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<User>(2, _omitFieldNames ? '' : 'users', $pb.PbFieldType.PM,
